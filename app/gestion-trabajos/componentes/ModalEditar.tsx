          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="md:col-span-2 space-y-3">
              ...
              <CampoFirmaDigital
                ...
                firmaIpad={{
                  negocioID,
                  trabajoFirebaseId: trabajo.firebaseId,
                  tokenPublico,
                  onTokenGenerado: setTokenPublico,
                }}
              />
              {urlPublica ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
              <div className="bg-[#ecf0f1] p-3 rounded-lg">
                ...
                <div className={`font-bold text-sm mt-1 px-2 py-1 rounded text-center ${
                  (trabajo as any).esGarantia || trabajo.estado === "GARANTIA" ? "bg-[#C2185B] text-white" :
                  (trabajo as any).sinReparacion || trabajo.estado === "SIN REPARACION" ? "bg-[#546E7A] text-white" :
                  ...
                  {(trabajo as any).esGarantia && trabajo.estado !== "GARANTIA"
                    ? `${trabajo.estado} · GAR`
                    : (trabajo as any).sinReparacion && trabajo.estado !== "SIN REPARACION"
                      ? `${trabajo.estado} · SIN REP`
                      : trabajo.estado}
                </div>
              </div>
              <div className="bg-[#ecf0f1] p-3 rounded-lg">
